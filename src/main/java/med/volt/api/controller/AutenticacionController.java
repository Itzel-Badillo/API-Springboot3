...
import med.volt.api.domain.usuarios.DatosAutenticarUsuario;
...
public class AutenticacionController {
    ...
    @PostMapping
    public ResponseEntity autenticarUsusario(@RequestBody @Valid DatosAutenticarUsuario datosAutenticarUsuario){
